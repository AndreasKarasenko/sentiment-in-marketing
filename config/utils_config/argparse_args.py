arguments = [
    {"arg": "--config_dir", "type": str, "default": "./config/model_config/search_space.json", "help": "Path to the search space config file"},
    {"arg": "--data_dir", "type": str, "default": "./samples/", "help": "Path to the data directory"},
    {"arg": "--model_dir", "type": str, "default": "./models/", "help": "Path to the model directory"},
    {"arg": "--optimized_dir", "type": str, "default": "./config/optimized/", "help": "Path to the optimized directory"},
